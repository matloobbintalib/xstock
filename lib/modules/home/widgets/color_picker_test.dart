...
import 'package:xstock/modules/home/widgets/alpha_picker_test.dart';
...
class ColorPickerTes extends StatefulWidget {
  const ColorPickerTes({
  ...
  @override
  State<ColorPickerTes> createState() => _ColorPickerTesState();
}

class _ColorPickerTesState extends State<ColorPickerTes> {
  _ColorPickerTesState();
