...
class NavRouter {
  ...
  static Future pushWithAnimation(
    ...
    return Navigator.push(
        context,
        PageTransition(
            type: type, child: route, duration: Duration(milliseconds: 450),alignment:hasAlignment ? Alignment.center:null));
  }
  ...
  static Future pushAndRemoveUntilWithAnimation(
    ...
    return Navigator.pushAndRemoveUntil(
        context,
        PageTransition(type: type, child: route,duration: Duration(milliseconds: 1000),alignment:hasAlignment ? Alignment.center:null),
            (Route<dynamic> route) => false);
  }
